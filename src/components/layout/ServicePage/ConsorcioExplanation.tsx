    ...
    return (
        <div className="container mx-auto py-12 px-4 lg:px-8">
            <div className="flex flex-col md:flex-row gap-8 items-center justify-center">
                ...
                {/* Caracteristicas */}
                <div className="p-6 bg-primary/10 rounded-lg mt-8 md:mt-0 ">
                    <h3 className={`${abhayaLibre.className} text-3xl text-primary mb-4 text-center`}>Principais vantagens</h3>

                    <div className="flex flex-col gap-4">
                        <AdvantagesService
                            title="Sem cobranças de juros"
                            description="Diferente do financiamento tradicional, no consórcio você não paga juros. Existe apenas uma taxa de administração, que é significativamente menor do que os juros cobrados em outras modalidades de crédito."
                            icon={<BadgeDollarSign className="h-6 w-6" />}
                        />

                        <AdvantagesService
                            title="Parcelas acessíveis"
                            description="Você escolhe o valor da carta de crédito e o prazo de pagamento, permitindo que as parcelas se adequem ao seu orçamento mensal sem comprometer suas finanças."
                            icon={<Calculator className="h-6 w-6" />}
                        />

                        <AdvantagesService
                            title="Poder de compra à vista"
                            description="Com a carta de crédito em mãos, você compra o bem à vista, podendo negociar descontos e melhores condições diretamente com o vendedor."
                            icon={<Trophy className="h-6 w-6" />}
                        />

                        <AdvantagesService
                            title="Flexibilidade na contemplação"
                            description="Você pode aguardar o sorteio mensal ou ofertar lances para antecipar sua contemplação. O lance pode ser feito com recursos próprios ou utilizando parte do próprio crédito (lance embutido)."
