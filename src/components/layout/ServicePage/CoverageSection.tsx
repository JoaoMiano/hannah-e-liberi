...
export const CoverageSection = ({ service }: { service: Servico }) => {
    return (
        <main className="container mx-auto py-8 lg:py-12 px-4 lg:px-8">
            <div>
                <h2 className={`${abhayaLibre.className} text-4xl md:text-5xl text-primary mb-4 text-center`}>Coberturas</h2>
                <p className="text-gray-600 mb-8 text-md md:text-lg text-center">Contratando um {service.titulo} com a gente, você garante diversas coberturas básicas e adicionais. Confira as principais.</p>
            </div>
